        ...
        if(taskList[i].isComplete == true){
            resultHTML+=`<div class="task task-done">
                    ...
                    <div class="button-box">
                        <button style="color: rgb(126, 126, 126);"><i class="fa-solid fa-play"></i></button>
                        <button onclick="toggleComplete('${taskList[i].id}')"><i class="fa-solid fa-rotate-right"></i></button>
                        <button onclick="deleteTask('${taskList[i].id}')" style="color: red;"><i class="fa-solid fa-trash-can"></i></button>
                    </div>
                </div>`
        } else{
            ...
            <div class="button-box">
                <button style="color: rgb(126, 126, 126);"><i class="fa-solid fa-play"></i></button>
                <button onclick="toggleComplete('${taskList[i].id}')" style="color: rgb(0, 168, 0);;"><i class="fa-solid fa-check"></i></button>
                <button onclick="deleteTask('${taskList[i].id}')" style="color: red;"><i class="fa-solid fa-trash-can"></i></button>
            </div>
        </div>`
        }
